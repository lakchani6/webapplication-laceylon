  ...
  return (
    <Container>
      ...
      <div className="other-controls">
        <div className="home item" onClick={()=>navigate("/home/admin")}>Home</div>
        <div className="home item" onClick={()=>navigate("/order")}>Orders</div>
      </div>
      ...
      {itemClick ? (
        <div className="logout-btn" id="logout-btn" onClick={onLogoutClick}>
          <LogoutIcon className="logout-icon" style={{height:"15px"}} />
          <span>Log out</span>
        </div>
      ) : (
        <></>
